...
import com.example.ad_btl.Fragment.Approving;
...
public class AdminMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_navigationad);
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener(){
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()) {
                        case R.id.id_nv_check:
                            fragment = new Home();
                            bundla.putSerializable("acc", accounts);
                            fragment.setArguments(bundla);
                            break;
                        case R.id.id_nv_cancel:
                            fragment = new Approving();
                            bundla.putSerializable("acc", accounts);
                            fragment.setArguments(bundla);
                            break;
                    }
